...
# input_path = "./MCUCXR/input/"
# input_path = './RSNA/sample_windowed/'
# input_path = './RSNA/test_windowed/'
# input_path = './RSNA/sample_png/'
#input_path = '../dataset/CHNCXR/input_sample_png/'
#output_path = '../dataset/CHNCXR/output_sample_png/'
# input_path = '../dataset/siim/input_problematic_png/'
input_path = '../dataset/RSNA/input_test_png'
...
# 5-10. Super Pixel
for i in range(n):
    arr2[i,:,:] = slic(arr1[i,:,:], n_segments = 15, sigma = 5)
    plt.axis('off')
    plt.subplot(1, 2, 1)
    plt.imshow(arr1[i,:,:], cmap=plt.cm.bone)
    plt.subplot(1, 2, 2)
